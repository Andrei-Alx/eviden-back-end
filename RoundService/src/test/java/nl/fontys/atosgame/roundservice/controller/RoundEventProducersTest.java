...
class RoundEventProducersTest {
    ...
    void produceRoundCreated() {
        ...
        RoundCreatedEventKeyValue roundCreatedEventKeyValue = new RoundCreatedEventKeyValue(mock(UUID.class), mock(Round.class));
        ...
        assertEquals(roundCreatedEventKeyValue.getRound(), message.getPayload().getRound());
        assertEquals(roundCreatedEventKeyValue.getGameId(), message.getHeaders().get(KafkaHeaders.MESSAGE_KEY));
    }
}